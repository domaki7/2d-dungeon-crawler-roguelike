...
## The Arena: wide open floor with only four corner posts — no cover, more
## enemies. A pure swarm fight that rewards kiting and AOE.
...
func _paint_corner_posts() -> void:
	var post_positions: Array[Vector2i] = [
		Vector2i(3, 3), Vector2i(20, 3), Vector2i(3, 12), Vector2i(20, 12),
	]
	for pos: Vector2i in post_positions:
