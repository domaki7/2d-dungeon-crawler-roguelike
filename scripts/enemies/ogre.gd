...
var speed: float:
	get:
		var base: float = GameConfig.config.ogre_speed * difficulty_speed_multiplier
		if status_effect_component:
			return base * status_effect_component.get_speed_multiplier()
		return base
var acceleration: float:
	get: return GameConfig.config.ogre_acceleration
var friction: float:
	get: return GameConfig.config.ogre_friction
